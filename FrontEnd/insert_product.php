...
if(isset($_POST['btn-upload']))
{
	...
	$sql = "INSERT INTO Product(PID,Name,Size,Brand,Cost)
	VALUES ('$PID','$Name','$Size','$Brand','$Cost')";
	...
	<center>
		<form action="insert_product.php" method="post" enctype="multipart/form-data">
		  <div class="table-sec">
			...
			<tr>
				<td>Product ID:</td>
				<td><input type="text" name="PID" class="hiii" id="t0" required ></td>
			</tr>
			...
			<tr>
				<td>Brand:</td>
			    <td><input type="text" name="Brand" class="hiii" id="t0" onkeyup="captitalize(this)" required>
			    </td>
			</tr>
